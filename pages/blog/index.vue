...
<template>
            ...
            <NuxtLink :to="`/blog/${post.slug.current}`" class="p-blog__card-link">
              ...
              <div class="p-blog__card-info">
                ...
                <div class="p-blog__card-tags">
                  <span v-for="(category, idx) in post.categories" :key="idx" class="p-blog__card-tag">
                    {{ category }}
                  </span>
                </div>
              </div>
    ...
    <h1>On affiche la page {{ page }}</h1>
        <div class="p-blog__pagination">
            <div v-for="n in 5" :key="n" class="" @click="onPageClick(n)">Page {{ n }}</div>
        </div>
  </template>
